...
### Added
- `--restart` flag for infinite restart-on-failure with 5s delay
...
[Unreleased]: https://github.com/metruzanca/bj/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/metruzanca/bj/compare/v0.4.0...v0.5.0
